...
export default function Home() {
  ...
  return (
<div className="font-sans grid grid-rows-[20px_1fr_20px] h-screen lg:h-[100vh] bg-gradient-to-b from-[#64857a35] to-[#07332472] items-center justify-items-center p-8 pb-20  sm:p-20 ">
